    ...
    if (this.props.error) {
      return (
        <div className="TasksPage">
          <div className="TasksPage__error">{this.props.error}</div>
        </div>
      )
    }
      ...
      <div className="TasksPage">
        <div className="TasksPage__header">
          {this.state.isEditingTaskList ? (
            ...
            <h2 className="TasksPage__title" onClick={this.handleEditTaskList}>
        ...
        {this.props.isLoadingTasks ? <CircularProgress /> : this.renderTasks()}
      </div>
    )
  }
}
